					...
					(c.isWindow = function(a) {
						...
						(c.data = function(a, b, e) {
							if (void 0 === e) {
								...
								var f =
									a[c.expando] || (a[c.expando] = ++c.uuid);
				...
				return (function(a, b, c, d) {
						...
						for (
							...
							h && f.loop !== !0 && h(e),
								g(l) &&
									f.loop === !0 &&
									!b &&
									(m.each(g(l).tweensContainer, function(
										a,
										b
									) {
										/^rotate/.test(a) &&
					...
					var m,
						...
						p = {
							...
							isSVG: function(a) {
								return (
									b.SVGElement && a instanceof b.SVGElement
								);
							},
					...
					var v = (t.CSS = {
							...
							extractValue: function(a, b) {
								...
								if (c) {
									...
									return (
										...
										b.toString().match(v.RegEx.valueSplit)[
											e
										]
									);
								}
									...
									(o =
										g(a) === d
											...
											: g(a).computedStyle
												...
												: (g(
														a
													).computedStyle = b.getComputedStyle(
														a,
														null
													))),
										"borderColor" === c &&
						...
						flushTransformCache: function(a) {
							...
							if (
								(n ||
									(t.State.isAndroid && !t.State.isChrome)) &&
								g(a).isSVG
							) {
								var d = {
									translate: [
							...
							t.mock !== !1 &&
								...
								h.display !== d &&
									...
									((h.display = h.display
										...
										.toLowerCase()),
									"auto" === h.display &&
										(h.display = t.CSS.Values.getDisplayType(
											f
										))),
								h.visibility !== d &&
									null !== h.visibility &&
								...
								function d() {
									void 0 !== g.data("induration") &&
										...
										void 0 !== g.data("outduration") &&
											(h.outDuration = g.data(
												"outduration"
											)),
										void 0 !== g.data("constrainwidth") &&
											(h.constrainWidth = g.data(
												"constrainwidth"
											)),
										void 0 !== g.data("hover") &&
	...
	(function(a) {
		...
		(a.fn.tabs = function(c) {
			return b[c]
				...
				: "object" != typeof c && c
					? void a.error(
							"Method " + c + " does not exist on jQuery.tabs"
						)
		...
		function b(f, g, i, l) {
			...
			function n() {
				w
					...
					u.editable ||
						w
							.on("focus." + t.id + " click." + t.id, function(
								a
							) {
